...
const songs = [
    new Audio("./assets/songs/flow-organically.mp3"),
    new Audio("./assets/songs/psychofunk.mp3"),
    new Audio("./assets/songs/action-soundtracking.mp3"),
    new Audio("./assets/songs/tim-burtonesque.mp3")
];
            ...
            <div className="container parallax" onMouseMove={onMouseMove} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}>
                <div className="card" style={{ transform, transition }} >
                    <div className="juan">
                        ...
                        <img src="./assets/cleanjuan.png" style={{ transform: juanTransform }} alt="juan" />
                    </div>
                    <div className="info">
